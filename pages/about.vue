<template>
  <div class="About">
    ...
    <TextCard :title="$t('データについて')">
      {{
        $t(
          '当サイトのデータは、北海道および札幌市のオープンデータをAPIで取得することで情報を更新しています。'
        )
      }}<br />
      {{
        $t(
          '当取り組みに北海道および札幌市が協力し、オープンデータ化にご尽力してくださっていることから、現在、「HTMLのスクレイピング」から「オープンデータサイトからの取得」にデータソースの切り替えを進めております。'
        )
      }}<br />
