    ...
    <div class="Flow-Card">
      ...
      <div class="only-sp">
        ...
        <div class="Flow-Card-Parts">
          ...
          <div class="TelLink">
            <a href="tel:0120565653"
              ><img src="/flow/sp/sp_flow_tel_01@2x.png" alt="0120-565653"
            /></a>
          </div>
          <div class="mt-4">
            <a href="#consult"
          ...
          <dl>
            <div class="SodanHeijitsu">
              ...
              <dd>
                <a
                  class="Link"
                  href="http://www.pref.hokkaido.lg.jp/hf/kth/kak/singatakoronahaien.htm#相談窓口"
                  target="_blank"
                  rel="noopener"
                >
                  各保健所の電話番号は地域保健課ページへ
            ...
            <div class="SodanYakan">
              <dt class="Yakan">
                土日祝日や夜間など<br /><span class="SodanTime"
                  >救急安心センターさっぽろ【受診相談】</span
                ><br />24時間対応
              </dt>
              <dd class="TelLink">
                <a href="tel:0112727119"
                  ><img src="/flow/sp/sp_flow_tel_03@2x.png" alt="011-272-7119"
                /></a>
              </dd>
            </div>
          </dl>
